  ...
  return (
    <section id="how-it-works" className="py-20">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="font-heading text-center text-4xl font-bold text-foreground md:text-5xl">How It Works</h2>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {steps.map((step, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card p-8 transition-all hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10">
                  {/* Step number */}
