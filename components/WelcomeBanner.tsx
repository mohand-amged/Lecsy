...
export default function WelcomeBanner({ userName, onDismiss, className }: WelcomeBannerProps) {
  return (
    <Card
      className={cn(
    ...
    >
      <CardContent className="p-6">
        <div className="flex items-center justify-between">
          ...
          <Button variant="ghost" size="sm" onClick={onDismiss} className="h-8 w-8 p-0 hover:bg-primary/10">
            <X className="h-4 w-4" />
          </Button>
        </div>
