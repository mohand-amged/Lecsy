      ...
      <div className="relative z-10">
        ...
        <nav className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
              Lecsy
            </div>
            <div className="flex items-center gap-2 sm:gap-4">
              <Button variant="ghost" asChild className="text-white/70 hover:text-white hover:bg-white/5 text-sm sm:text-base px-2 sm:px-4">
                <Link href="/auth/login">Sign In</Link>
              </Button>
              <Button asChild className="bg-indigo-600 hover:bg-indigo-700 text-white text-sm sm:text-base px-3 sm:px-4">
        ...
        <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="mb-6 sm:mb-8">
              <span className="inline-block px-3 sm:px-4 py-2 bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6">
                🚀 Welcome to the Future of Learning
              </span>
            </div>

            <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white via-indigo-200 to-purple-200 bg-clip-text text-transparent leading-tight">
              Transform Your
              <br />
              <span className="relative">
                Learning Journey
                <div className="absolute -bottom-1 sm:-bottom-2 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full transform scale-x-0 animate-pulse"></div>
              </span>
            </h1>

            <p className="text-base sm:text-xl md:text-2xl text-white/60 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
              <Button
                size="lg"
                className="w-full sm:w-auto text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-500/20 hover:shadow-xl hover:shadow-indigo-500/30 transition-all duration-300 transform hover:scale-105"
                asChild
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 border-2 border-white/10 text-white hover:bg-white/5 transition-all duration-300 bg-transparent"
                asChild
              >
        ...
        <section id="features" className="container mx-auto px-4 sm:px-6 py-12 sm:py-20">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 text-white">Why Choose Lecsy?</h2>
